...
namespace UCSP.Services.CartAPI.Migrations
{
    ...
    [Migration("20231222191141_CartTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UCSP.Services.CartAPI.Models.CartDetails", b =>
                {
            ...
            modelBuilder.Entity("UCSP.Services.CartAPI.Models.CartHeader", b =>
                {
                    b.Property<int>("CartHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UCSP.Services.CartAPI.Models.CartDetails", b =>
                {
                    b.HasOne("UCSP.Services.CartAPI.Models.CartHeader", "CartHeader")
                        .WithMany()
